...
- When creating or styling a component, first look for a suitable daisyUI component in the official documentation at https://daisyui.com/llms.txt. Use and adapt that component with Tailwind CSS v4 utilities as needed; only build the component with Tailwind CSS v4 utilities from scratch when no suitable daisyUI component exists.
